...
public class JavaClassExecutor {
	...
	public static String execute(byte[] classByte, String systemIn) {
		...
		// 3. 调用ClassModifier#modifyUTF8Constant修改
		byte[] modifyBytes = cm.modifyUTF8Constant("java/lang/System", "com/gitthub/wujun728/engine/bytecodes/execute/HackSystem");
		modifyBytes = cm.modifyUTF8Constant("java/util/Scanner", "com/gitthub/wujun728/engine/bytecodes/execute/HackScanner");
	...
	public static String execute(StringSourceCompilerExtend compilerExtend, String systemIn) {
		...
		Map params = HttpRequestLocal.getAllParameters(request);
		HotSwapClassLoader classLoader = new HotSwapClassLoader(ClassLoaderUtil.get());
		...
		for (JavaFileObject javaFileObject : fileObjectMap.values()) {
			try {
				...
				byte[] modifyBytes = cm.modifyUTF8Constant("java/lang/System", "com/gitthub/wujun728/engine/bytecodes/execute/HackSystem");
				modifyBytes = cm.modifyUTF8Constant("java/util/Scanner", "com/gitthub/wujun728/engine/bytecodes/execute/HackScanner");
				modifyBytes = cm.modifyUTF8Constant("java/util/ArrayList", "com/gitthub/wujun728/engine/bytecodes/execute/HackArrayList");
				modifyBytes = cm.modifyUTF8Constant("java/util/HashMap", "com/gitthub/wujun728/engine/bytecodes/execute/HackHashMap");
